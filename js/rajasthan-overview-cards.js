document.addEventListener('DOMContentLoaded', function () {
  ...
  if (facts) facts.textContent = '16 guides';
  ...
  var cards = [
    ...
    ['alwar-sariska.html', 'HERITAGE & WILDLIFE · 2–3 DAYS', 'Alwar & Sariska', 'Alwar heritage, Siliserh Lake and a permit-led Sariska safari—planned without a rushed forest day.']
  ];
